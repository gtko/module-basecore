...
class PhoneRepository extends AbstractRepository implements PhoneRepositoryContract
{
    ...
    public function searchQuery(Builder $query, string $value, mixed $parent = null): Builder
    {
       ...
       // All list country indicative phone
        $indicatives = collect([
            '44' => 'UK (+44)',
            '1' => 'USA (+1)',
            '213' => 'Algeria (+213)',
        ...
        $valueSansIndicatif = $value;
        foreach($indicatives as $indicative){
            $valueSansIndicatif = str_replace('+'.$indicative, '0', $valueSansIndicatif);
        }
...
//       $valueSansIndicatif = preg_replace( '@^\+[0-9]{2}@', '0',$value);
       ...
       return $query
           ...
           ->OrWhere('phone', 'LIKE', '%'.$valueSansIndicatif.'%');
    }
