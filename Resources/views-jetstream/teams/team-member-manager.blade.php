<div>
    ...
    <x-jet-dialog-modal wire:model.defer="currentlyManagingRole">
        <x-slot name="title">
            {{ __('Manage Role') }}
        </x-slot>
    ...
    <x-jet-confirmation-modal wire:model.defer="confirmingLeavingTeam">
        <x-slot name="title">
            {{ __('Leave Team') }}
        </x-slot>
    ...
    <x-jet-confirmation-modal wire:model.defer="confirmingTeamMemberRemoval">
        <x-slot name="title">
