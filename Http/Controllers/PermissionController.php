...
class PermissionController extends Controller
{
    ...
    */
    public function index(Request $request)
    {
        ...
        return view('basecore::app.permissions.index')
    ...
    */
    public function create()
    {
        ...
        $roles = Role::all();
        return view('basecore::app.permissions.create')->with('roles', $roles);
    }
    ...
    */
    ...
    {
        $this->authorize('views', Permission::class);

        return view('basecore::app.permissions.show')->with('permission', $permission);
    }
    ...
    */
    public function edit(Permission $permission)
    {
        ...
        return view('basecore::app.permissions.edit')
